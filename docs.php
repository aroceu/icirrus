...
<p>So that's what I did. I've also moved all of the Pok&eacute;mon archived here to the most recent storage systems (currently Pok&eacute;mon Home) so I can reset the games now while my old Pok&eacute;mon remain accessible to me. But I still really only ever play the games once.</p>
...
<p>After dropping out and traveling, I lived with my mom and had few obligations and a lot of mental health issues. So it was a good time for me to put way too much time into my hobbies, including web development and design. After the idea of creating a personal archive crystallized in my head, I worked on it immediately and obsessively, as I do with any creative project I take on. </p>
...
<p>The pages that I designed in their beginning stages that are pretty much the same today are:</p>
...
<p>Lastly, I made the Pok&eacute;mon Go section, which was the Pok&eacute;mon link in the Gym at the time. I'd put it off to work on at the end because it required me to archive game data again, when the other sections were more about the site. Before I even started it, I knew that I wanted the webpage to look like it had been taken straight from the Pok&eacute;mon Go app. So I implemented a CSS gradient background, turned my in-game trainer into a PNG, and archived my dex progress by displaying hundreds of sprites on one page. I've updated the trainer info off and on as often as I play Pok&eacute;mon Go, though I like my current avatar a lot (added during the November 2024 update) that I don't anticipate changing it much any time soon.</p>
