...
<p>I like that all the trainer pages have such vastly different color themes despite following the same template. When I was younger, for my second main domain I tried to do something similar, but for my different hobbies online. I'd always liked the idea of making a bunch of differently colored and stylized websites all under the same umbrella; but doing it for my hobbies felt like I was splintering myself apart, and didn't satisfy that desire the way I wanted. Doing it for my Pok&eacute;mon team archive makes more sense though, because the colors are respective to the games, and are actually more necessary and relevant for these pages. I love design because so often it depends on function, and being able to scratch this I've had for making multi-color but interconnected webpages shows how integral function can be in design. Additionally, adding more platform-specific quirks&mdash;the use of shadowing for 3DS games to give it a "3D" effect, borders on the sides of Switch games&mdash;makes those designs so much more fun and unique across the board.</p>
