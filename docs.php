...
<p>The design for the mainline game pages is simplistic, but that's intentional: I'm a minimalist and not as inclined to elaborate graphic design, so I make the focus on the content the crux of a webpage's design instead. Plus, when I was 18 I liked the idea of having a network of webpages that each had a distinct color theme that I could collate together like a rainbow. I tried to implement that rainbow idea for another website project before, but that didn't bring me the satisfaction I'd hoped. Distinguishing my Pok&eacute;mon parties across different games, however, certainly does. It feels a little full circle being able to channel this older creative idea into this newer, more suitable one.</p>
...
<p>Similarly, a lot of the tactics I use in both structure and design on this website are deliberately different from my other web projects. This came about due to the nature of this site; my mentaliy isn't any different. Some strategies that I've only ever used on this project include:</p>
...
<p>At least, for the first three. See, when I played Pok&eacute;mon Platinum, I had a stupid ambition: to beat the game with only one, unevolved starter. That starter was Chimchar, and it ended up working eventually thanks to RNG. I didn't want to display it like the other pages, though, which had more Pok&eacute;mon. That would make it look plain and boring, and conflicted with my playthrough of Platinum, which, however inefficient, was still special to me at the time. So I changed it, even only just a little bit, to tie in that feeling to the webpage.</p>
...
<p>While I had been wracking my brain for page ideas to replace the Pok&eacute;mon section, I got other less relevant but still enticing ideas in the process. I decided that I would have the Pok&eacute;Rogue section be a part of a wider fangames section, so I can put it off until I play more fangames. Another thing that occurred to me was that I could make a Secret Base of my IRL trinkets. I'd already been considering a section for some of my more materialistic things on my personal website, but I also have a lot of Pok&eacute;mon merch and realized that hey, I could make a page like that here, too. The only excuse I could give myself to procrastinate on it was that I'd ideally like to have a customized Secret Base used as navigation but couldn't make it that easily on my computer yet...and then I found <a href="https://pamtre-berry.neocities.org/fun/secretbase#">Pamtre-Berry's Secret Base maker</a> which had somehow escaped my notice ages before that very moment. So I no longer had that excuse.</p>
