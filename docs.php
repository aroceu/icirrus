...
<p>The site was originally named <i>MASTERBALL</i>, because it was hosted under my old domain &mdash; pkmn.arose.nu. I didn't have a domain for it, partially for financial reasons at the time, but also because even if I did, I didn't know if I wanted it to be something like masterball.com/org/net/info/whatever else. I didn't want its name to feel too tied to its identity &mdash; and I suppose this comes from my fear of permanence, with how incredibly indecisive I can be.</p>
...
<p>I'm pretty sure I'd been thinking about having <b>icirr.us</b> as its URL for a while &mdash; it was just a matter of committing to it. Especially as I'd decided to let arose.nu expire in 2018, so I'd need to move the Pok&eacute;mon section to a new domain regardless. I couldn't think of anything better in that time, anyway &mdash; I bought the domain over a year after I'd made most of the site in the first place. It was still a work-in-progress, anyway. Plus, like I've said in other places, I liked Pok&eacute;mon before I've even been online. Having it be its own separate website away from anything specifically IRL or "online" was its optimal place for me, and Masterball/Icirrus reflects that &mdash; not tied to me specificially, but still representative of something I love or feels reflective of my love for Pok&eacute;mon in some way.</p>
...
<p>It does have my IRL name and is the website I show to IRL people when they ask about the kind of websites I like to make, though, so you know. Your mileage may vary and whatnot.</p>
...
<p>The specialized pastel graphics I made are quite fun as well. It wasn't part of the original plan I believe, but the more I created this pastel 2D masterball aesthetic, the easier it was for me to make graphics with the same motif. Like I said before, I'm not much of a visual artist &mdash; but this is more vectoring than anything, and with a pretty simplistic shape to go off and a distinct design, it took a good amount of creativity that I was more comfortable with than not. Plus, I had a student copy of Photoshop. That was nice too.</p>
...
<p>With sections like these, I write all the actual page content in HTML first, and then convert it to a webpage and then push it through Github (Desktop) when I'm done. Writing is the most tedious part for me &mdash; I still love it though, but damn does it take time and energy and focus that I don't always have.</p> 
...
<p>Of course, though the saga for now ends here, I'm always making tiny changes every so often. And I'll play Ultra Moon and Violet and update these docs to reflect that. Eventually. I'm just indecisive and lazy and have a ridiculous attention span, and not always in the best way.</p>
