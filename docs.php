...
<p>Still, I knew what felt right. So despite my lack of ideas, I made the navigation of putting the Go and TGCP sections together, in what's now known as the Wild Area. But it was Pok&eacute;mon in the gym first, which was also how I came up with the idea of making it look like the starter selection screen in Pok&eacute;mon Ruby/Sapphire/Emerald, since that's another stage of the game where you'll have to encounter Pok&eacute;mon. Soon after considering the starter selection screen as this new navigational page's aesthetic motif, I remembered that I'd been wanting to employ the logic of radio buttons as in-page navigation for an eventual project. And that was basically perfect for it. Once I made it work, I liked it a lot&mdash;but I also knew it didn't quite fit in the Gym section. I knew I was going to move it. I just needed to think of something to replace it first.</p>
