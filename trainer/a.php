...
.close a:link, .close a:visited{
	color: #fff;
  text-shadow: 0.08em 0.08em 0 #b7574d;
text-decoration: none;
}
...
hr{
	border-top: none;
	border-bottom: 3px solid #b7574d;
	width: 70%;
	margin: 2em auto;
}
...
#trainerinfo a:hover, #trainerinfo a:focus{
	color: #5385a0;
}
...
img.kingdra, img.talonflame, img.luxray{
	float: left;
	padding: 10px 10px 10px 0;
}

img.sceptile, img.mienshao, img.aggron{
	float: right;
...
<div class="right"><b>ID:</b> #49385 (ORASXY) <br /><b>NATURE:</b> Mild, likes to fight</div></div>
	...
	<blockquote><img src="https://icirr.us/trainer/trainer.gif" class="trainerimg" alt="Pokemon Ranger (female)"><p>Rangers appearing in core series games collect and train Pokémon just like other regular Pokémon Trainers. However, they are still primarily concerned with protecting wild Pokémon, keeping the environment safe, and making sure travelers do not get injured or lost when walking through the wilderness, as they mention in their battle dialogue.</p>
...
<p><img src="https://icirr.us/trainer/kingdra.gif" class="kingdra favmon" alt="Kingdra"> <b>kingdra</b> <img src="https://icirr.us/mb.png" alt=""> My favorite &hearts; I like 'mon based on their aesthetic and typing most of the time, though their battle viability may make a difference in some cases. Kingdra is the peak of this for me; as a huge water lover and a dragon lover and the excellent defense of those two types together, as well as kingdra'ss simplistic-but-elegant design, it's no wonder it would become my favorite. It was difficult to get in gen III, though, but my brother and I had a link cable and I managed to evolve one years later when I was 16 and knew with surety that Kingdra was my favorite. It was named <i>Yin Yang</i> after my obsession with the motif at the time, and its ability was Sniper, which is kingdra's inferior ability, and middling stats. But as someone who likes long range attacks, it works for me. Though the others here may come quite close, I don't think anything will top a pok&eacute;mon that feels made for me.</p>

<p><img src="https://icirr.us/trainer/sceptile-mega.gif" class="sceptile favmon" alt="Mega Sceptile"><b>sceptile</b> <img src="https://icirr.us/mb.png" alt=""> My first ever pok&eacute;mon &hearts; I mostly chose treecko because the friend from summer camp who I'd watched all the time had a treecko (also named Ecko, by the way &mdash; I am so original) who she evolved into a grovyle, and I thought both were pretty cool. Ever since then, whenever I played a Hoenn game, it didn't feel right if I didn't start with treecko first. Sceptile is awesome too; I love me a glass cannon, because that's the kind of fighter I am myself. Mega sceptile being half dragon type (numerically technically my 'favorite' type) felt perfect for it too. And for me.</p>

<p><img src="https://icirr.us/trainer/talonflame.gif" class="talonflame favmon" alt="Talonflame"><b>talonflame</b> <img src="https://icirr.us/mb.png" alt=""> I've always been a huge early birds fan, and though talonflame wasn't the first for me, the moment I saw it I fell in love with its design. I love a red and blue color palette and that's what talonflame is, with the fire and flying type on top of that, a fun typing even if it is especially weak to rocks. But who cares about rocks when you've got a badass bird with one of the best speed stats, you know? Its name also sounds like the old nicknames I used to give my pok&eacute;mon (as you may see here), so it just fits alongside me.</p>

<p><img src="https://icirr.us/trainer/mienshao.gif" class="mienshao favmon" alt="Mienshao"><b>mienshao</b> <img src="https://icirr.us/mb.png" alt=""> Absolutely my favorite pok&eacute;mon in gen V <strike>rip my love for bisharp tbh</strike>, and also my favorite fighting type, which I've always liked in theory but much more rarely in practice. Mienshao, however, fits the bill perfectly for me &mdash; an elegant long-range fighter with the drawback of being frail if it gets hit more than once. Sounds familiar, doesn't it? Not to mention its lovely color palette, because honestly I liked it the moment I saw it before I even knew how it played. I love pastels, and you can never go wrong with pinks. I don't feel any particular way about ermines, but maybe I should.</p>
...
<li>Even though it was totally overpriced, I own a few things from the <a href="https://bulbapedia.bulbagarden.net/wiki/Pok%C3%A9mon_Shirts">Pok&eacute;mon Shirts collection</a> &mdash; a Jigglypuff, Seadra, and Kingdra bandana, a Luvdisc facemask, and a Sceptile tropical shirt.</li>
<li><img src="jigglypuff.jpg" alt="Jigglypuff Pokemon Card Jungle expansion" style="float: right; height: 90px; padding-left: 10px; padding-top: 0px;">My first Pok&eacute;mon card was the only bit of Pok&eacute;mon I ever really had between 1998 and 2004 (well, aside from the VHS tapes of <i>Pok&eacute;mon: the First Movie</i> and the first 3 episodes) &mdash; Jigglypuff from the 1999 Jungle expansion.</li>
<li><img src="tcg.jpg" alt="Kingdra Pokemon Card Shrouded Fable expansion" style="float: right; height: 90; padding-right: 10px;padding-top: 10px;margin-top: -20px;"> I don't have that card anymore, but I did recently buy a new one &mdash; Kingdra from the Shrouded Fable expansion.</li>
</ul>
</div>
...
<div class="ot">
	<div class="close">
		<p align="center">
			<a href="https://icirr.us/trainer">&laquo; BACK TO TRAINER <img src="https://icirr.us/trainer.png" alt=""></a>
		</p>
		</div>
	</div>
